...
<div class="profile-topbar">
    ...
    <a href="#notifications" class="icon-notifications">Уведомления</a>
...
?>
    ...
    if (isset($_POST['send_friend_request'])) {
        ...
        <div id="friend-requests" class="profile-friend-requests">
    ...
    if ($profile_user_id === $current_user_id) {
        ...
        // Отладка: выводим входящие запросы для текущего пользователя
        echo "<pre>Входящие запросы для пользователя {$current_user_id}: " . print_r($incoming_requests, true) . "</pre>";

       
        

        // Отображение запросов на дружбу
        if (!empty($incoming_requests)) {
            ...
            echo '<p>Нет новых запросов на дружбу.</p>';
        }
        ...
        // Отображение запросов на дружбу для других пользователей
        echo "<p>Вы не можете управлять запросами на дружбу другого пользователя.</p>";
    }
    ?>
</div>
...
<div id="reviews" class="profile-section" style="display: none;">
    ...
    ?>
            ...
            <!-- Уведомления -->
            <div id="notifications" class="profile-notifications section" style="display: none;">
                <h3>Уведомления</h3>
                <?php
                $notifications = get_user_meta($profile_user_id, 'notifications', true);
                if ($notifications) {
