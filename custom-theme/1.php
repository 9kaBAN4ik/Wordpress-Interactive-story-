...
<div id="primary" class="content-area">
            ...
            <div id="interactive-story-constructor" class="interactive-story-constructor">
                ...
                <form id="interactive-story-form" method="post">
                    ...
                    <div class="tabs">
                        ...
                        <button type="button" class="tab-link" data-tab="illustration">Авто-иллюстрирование</button>
                    </div>
    ...
    <div id="illustration-container">
        <div id="graph-container"></div>
                ...
                window.story_paragraphs = <?php echo json_encode($story_paragraphs); ?>;
                window.story_facts = <?php echo json_encode($story_facts); ?>;
                window.story_resources = <?php echo json_encode($story_resources); ?>;
                window.story_formulas = <?php echo json_encode($story_formulas); ?>;
            </script>
